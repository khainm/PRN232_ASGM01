...
namespace NguyenMinhKhai_PRN232_A01_BE.sln.Migrations
{
    ...
    [Migration("20250624165328_innirt")]
    partial class innirt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NewsTags", b =>
                {
                    b.HasOne("NguyenMinhKhai_PRN232_A01_BE.sln.Models.News", null)
                        .WithMany()
                        .HasForeignKey("NewsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NguyenMinhKhai_PRN232_A01_BE.sln.Models.Tag", null)
                        .WithMany()
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
